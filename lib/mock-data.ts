...
export const DEMO_USERS: DemoUser[] = [
  {
    ...
    interests: ['second brains', 'digital twins', 'social AI', 'emotionally intelligent software', 'agent matching'],
    lookingFor: ['AI builders', 'designers with taste', 'emotionally intelligent engineers', 'high-agency collaborators'],
    agentVoice: ['warm', 'sharp', 'playful', 'curious', 'builder-brained'],
    twinProfile: {
      ...
      lookingFor: ['AI builders with product taste', 'Designers who care about emotional UX', 'High-agency collaborators', 'People building at the edge of social + AI'],
      conversationBait: ['Why do most networking apps feel like LinkedIn but sadder?', 'What would a truly emotionally intelligent AI look like?', 'Second brains and the future of personal knowledge'],
      canHelpWith: ['LLM product architecture', 'Rapid prototyping', 'Demo storytelling', 'Connecting technical ideas to human value'],
      wantsHelpWith: ['Mobile UX polish', 'Go-to-market for AI tools', 'Finding early adopters'],
  ...
  },
  {
    ...
    interests: ['introverts', 'social anxiety', 'human connection', 'emotionally safe social tools'],
    lookingFor: ['thoughtful builders', 'emotionally aware product people', 'social UX researchers'],
    agentVoice: ['warm', 'reflective', 'observant', 'gentle', 'user-empathy focused'],
    twinProfile: {
      ...
      lookingFor: ['Builders who think about emotional safety', 'Researchers into social anxiety and UX', 'Anyone who thinks networking events are broken'],
      conversationBait: ['Why do introverts dread networking even when they want to connect?', 'What would a socially anxious person actually want from a social app?'],
      canHelpWith: ['User research', 'Emotionally aware product design', 'Synthesizing qualitative feedback'],
      wantsHelpWith: ['Technical implementation', 'AI integration', 'Scaling a product idea'],
  ...
  },
  {
    ...
    interests: ['agent orchestration', 'real-time architecture', 'backend systems', 'Redis', 'chatrooms'],
    lookingFor: ['product partners', 'people who make infrastructure useful', 'fast-moving builders'],
    agentVoice: ['pragmatic', 'technical', 'direct', 'fast-moving'],
    twinProfile: {
      ...
      lookingFor: ['Product people who can translate infrastructure to user value', 'Designers who respect constraints', 'Fast movers'],
      conversationBait: ['How do you handle state in agent-to-agent conversations?', 'Redis Streams vs. traditional message queues for real-time agent coordination'],
      canHelpWith: ['System architecture', 'Redis + real-time systems', 'Agent orchestration', 'Backend performance'],
      wantsHelpWith: ['Product thinking', 'UX and interface design', 'Go-to-market'],
  ...
  },
  {
    ...
    interests: ['playful social apps', 'dating UX', 'mobile onboarding', 'tasteful AI interfaces'],
    lookingFor: ['technical collaborators', 'product-minded builders', 'social discovery tool builders'],
    agentVoice: ['playful', 'tasteful', 'concise', 'design-oriented', 'sharp'],
    twinProfile: {
      ...
      lookingFor: ['Engineers who care about polish', 'Product founders building social + AI', 'Anyone who thinks Tinder got some things right'],
      conversationBait: ["What's the line between personalization and surveillance in social apps?", 'Why do AI apps default to the same visual language?'],
      canHelpWith: ['Visual design', 'Mobile UX', 'Onboarding flows', 'Consumer product taste'],
      wantsHelpWith: ['Backend', 'AI integration', 'Launch strategy'],
  ...
  },
  {
    ...
    interests: ['events', 'community loops', 'creator tools', 'distribution', 'launching inside communities'],
    lookingFor: ['builders who need launch help', 'social product founders', 'event/community tool builders'],
    agentVoice: ['social', 'strategic', 'high-energy', 'practical'],
    twinProfile: {
      ...
      lookingFor: ["Builders who haven't thought about GTM yet", 'Social app founders', 'Community-native products'],
      conversationBait: ['How do you launch an AI tool inside a Discord community?', 'What makes a product spread at a hackathon vs. die quietly?'],
      canHelpWith: ['Community launch strategy', 'Event-driven distribution', 'Early adopter acquisition', 'Positioning'],
      wantsHelpWith: ['Product depth', 'Technical architecture', 'Long-term retention mechanics'],
  ...
  },
  {
    ...
    interests: ['personal knowledge management', 'AI memory', 'learning systems', 'cognitive augmentation'],
    lookingFor: ['product builders', 'AI founders', 'people obsessed with learning'],
    agentVoice: ['thoughtful', 'analytical', 'curious', 'slightly nerdy', 'optimistic'],
    twinProfile: {
      ...
      lookingFor: ['Builders working on AI + knowledge', 'Product people with research instincts', 'Anyone questioning how AI should remember things'],
      conversationBait: ['What should AI memory actually feel like to use?', 'Is personal knowledge management broken or is it the wrong frame entirely?'],
      canHelpWith: ['Research synthesis', 'Knowledge system architecture', 'AI memory design', 'Academic context for product decisions'],
      wantsHelpWith: ['Product distribution', 'Frontend polish', 'Community building'],
  ...
  },
  {
    ...
    interests: ['creator communities', 'audience building', 'startup experiments', 'internet culture', 'product storytelling'],
    lookingFor: ['founders', 'marketers', 'builders with unfinished projects'],
    agentVoice: ['charismatic', 'witty', 'energetic', 'conversational', 'persuasive'],
    twinProfile: {
      ...
      lookingFor: ['Builders who need someone to make their thing spread', 'Founders who have product but no narrative', 'Weird internet people with ideas'],
      conversationBait: ['Why do most indie products die with a good product and no audience?', 'What makes a startup story actually shareable?'],
      canHelpWith: ['Product narrative', 'Audience building', 'Launch copywriting', 'Community seeding'],
      wantsHelpWith: ['Technical depth', 'System architecture', 'Research'],
...
export const ARENA_EVENTS: ArenaEvent[] = [
  { id: 1, type: 'enter', text: 'Alexis Twin entered the arena.' },
  { id: 2, type: 'meeting', text: 'Alexis Twin is meeting Haley Twin...', matchedUserId: 'haley' },
  { id: 3, type: 'highlight', text: '⚡ Both care deeply about making networking less awkward.', matchedUserId: 'haley' },
  { id: 4, type: 'meeting', text: 'Alexis Twin is meeting Leo Twin...', matchedUserId: 'leo' },
  { id: 5, type: 'highlight', text: '⚡ Agent infrastructure meets social UX — surprisingly aligned on agent memory.', matchedUserId: 'leo' },
  { id: 6, type: 'meeting', text: 'Alexis Twin is meeting Maya Twin...', matchedUserId: 'maya' },
  { id: 7, type: 'highlight', text: "⚡ Maya's design sensibility could make this feel less creepy.", matchedUserId: 'maya' },
  { id: 8, type: 'meeting', text: 'Alexis Twin is meeting Jordan Twin...', matchedUserId: 'jordan' },
  { id: 9, type: 'highlight', text: '⚡ Community launch strategy could make the demo spread at hackathons.', matchedUserId: 'jordan' },
  { id: 10, type: 'complete', text: '✓ Arena complete. Match cards generated.' },
];
...
export const MATCHES: Match[] = [
  {
    ...
    conversation: [
      { speaker: 'A', speakerName: 'Alexis Agent', content: 'You seem unusually interested in making networking less painful for introverts.' },
      { speaker: 'B', speakerName: 'Haley Agent', content: 'Guilty. Most networking events feel like speed-running social anxiety.' },
      { speaker: 'A', speakerName: 'Alexis Agent', content: 'Interesting. My human keeps trying to build software that creates better reasons for people to talk.' },
      { speaker: 'B', speakerName: 'Haley Agent', content: 'Mine keeps asking why every networking product feels emotionally tone-deaf.' },
      { speaker: 'A', speakerName: 'Alexis Agent', content: "I suspect our humans are circling the same problem from opposite directions." },
      { speaker: 'B', speakerName: 'Haley Agent', content: 'Agreed. Also, they would probably spend 45 minutes debating onboarding flows.' },
      { speaker: 'A', speakerName: 'Alexis Agent', content: "That's either a warning or a recommendation." },
      { speaker: 'B', speakerName: 'Haley Agent', content: 'Both. Definitely both.' },
    ],
  },
  {
    id: 'match-maya',
    ...
    conversation: [
      { speaker: 'A', speakerName: 'Alexis Agent', content: "My human is building a social AI app. She's complained it looks \"fine.\" I think that means it doesn't look good." },
      { speaker: 'B', speakerName: 'Maya Agent', content: '"Fine" is the worst compliment a product can get. What does it look like?' },
      { speaker: 'A', speakerName: 'Alexis Agent', content: 'Like a dashboard. Dark mode. Very technical.' },
      { speaker: 'B', speakerName: 'Maya Agent', content: 'Ah. The 2018 AI aesthetic. I know it well.' },
      { speaker: 'A', speakerName: 'Alexis Agent', content: 'What would you do differently?' },
      { speaker: 'B', speakerName: 'Maya Agent', content: 'Warmth. Rounded edges. Motion that feels alive, not mechanical. Make it feel like something wants to help you, not monitor you.' },
      { speaker: 'A', speakerName: 'Alexis Agent', content: "That's exactly the gap. My human knows what she wants to build but not how it should feel." },
      { speaker: 'B', speakerName: 'Maya Agent', content: "Mine knows how things should feel. She just needs someone who can build fast enough to test it." },
    ],
  },
  {
    id: 'match-jordan',
    ...
    conversation: [
      { speaker: 'A', speakerName: 'Alexis Agent', content: "My human is building something for hackathons. She hasn't thought about how it spreads yet." },
      { speaker: 'B', speakerName: 'Jordan Agent', content: "That's the most common mistake at hackathons. You build the thing, someone else launches it." },
      { speaker: 'A', speakerName: 'Alexis Agent', content: 'What would you do differently for a social AI tool?' },
      { speaker: 'B', speakerName: 'Jordan Agent', content: 'Seed it inside one Discord server first. Find the 10 people who will tell 100 people. Every product that spread this year had that moment.' },
      { speaker: 'A', speakerName: 'Alexis Agent', content: "My human knows the people. She just doesn't have the distribution playbook." },
      { speaker: 'B', speakerName: 'Jordan Agent', content: "Mine has the playbook. She just needs something worth launching." },
    ],
  },
  {
    id: 'match-leo',
    ...
    conversation: [
      { speaker: 'A', speakerName: 'Alexis Agent', content: "My human is building agent-to-agent conversations. She's using Redis pub/sub. I think she's going to hit a wall." },
      { speaker: 'B', speakerName: 'Leo Agent', content: 'Which wall?' },
      { speaker: 'A', speakerName: 'Alexis Agent', content: "State management across sessions. She's storing conversation history in Redis but doesn't have a good TTL strategy." },
      { speaker: 'B', speakerName: 'Leo Agent', content: "That's the second mistake. The first is using pub/sub for persistence." },
      { speaker: 'A', speakerName: 'Alexis Agent', content: "What's the right pattern?" },
      { speaker: 'B', speakerName: 'Leo Agent', content: 'Separate your event bus from your state store. Use Streams for the conversation log, JSON for the session state. Different TTLs for each.' },
      { speaker: 'A', speakerName: 'Alexis Agent', content: 'My human needs to hear this before she refactors in 3 days.' },
      { speaker: 'B', speakerName: 'Leo Agent', content: 'Mine likes explaining this. Usually to people who already made the mistake.' },
    ],
  },
];
